...
public class AuthController {
    ...
    public AuthController(JwtTokenUtil jwtTokenUtil, ValidatingServiceV3 validatingService, UsersRepository usersRepository, ModelMapper mapper, UserRepositoryV3 userRepositoryV3) {
